                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-danger">{{trans('Students_trans.oldstudentstage')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.oldstudentyear')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.oldstudentclass')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.oldstudentsection')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.nowstudentstage')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.Nowstudentyear')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.Nowstudentclass')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.Nowstudentsection')}}  </th>
